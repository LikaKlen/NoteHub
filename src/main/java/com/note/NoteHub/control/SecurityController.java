...
//        if (!Objects.equals(teacher.getEmail, signinRequest.getEmail())) {
...
//
//        NoteHubApplication.currentUser = userService.loadUserEntityByUsername(signinRequest.getUserName());
